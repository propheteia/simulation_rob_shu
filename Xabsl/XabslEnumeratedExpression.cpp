  ...
  symbol(0), parameters(0)
{
  ...
  {
    errorHandler.error("XabslEnumeratedInputSymbolRef::Xabls2EnumeratedInputSymbolRef(): enumerated input symbol \"%s\" was not registered at the engine",buf);
    return;
  }
  ...
  if (enumeration != NULL && enumeration != this->enumeration)
  {
    errorHandler.error("XabslEnumeratedInputSymbolRef::Xabls2EnumeratedInputSymbolRef(): enumeration input symbol \"%s\" does not match enumeration type \"%s\"", buf, enumeration->n);
  }
